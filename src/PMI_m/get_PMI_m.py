...
def pmi_getter (c_code):
    ...
    if c_code != "US":
        scraped = tedata.scrape_chart(url = f"https://tradingeconomics.com/{countries[c_code]}/manufacturing-pmi")
    else:
        scraped = ted.scrape_chart(url = "https://tradingeconomics.com/united-states/business-confidence")
